const en: any = {
  ...
  paragraphMan:
    "Princesa De Peñasco offers quality condos in the Sandy Beach. Their installations are equipped to satisfy their clients' needs during their stay.",
  listPrincesa: {
...
const es: any = {
  ...
  paragraphMan:
    'Princesa de Peñasco ofrece condominios de calidad frente a la playa. Sus instalaciones están equipadas para satisfacer las necesidades de sus clientes durante su estancia.',
  listPrincesa: {
