let en = {
    ...
    paragraphMan: 'Princesa De Peñasco offers quality condos in the Sandy Beach. Their installations are equipped to satisfy their clients\' needs during their stay.',
    listPrincesa: {
        security: '24 hour security',
        parking: 'Parking',
        restaurant: 'Restaurant bar "Colin\'s"',
        store: 'Convenience Store',
        gym: 'Gym',
        grill: 'Communal barbecue grills',
        adultPool: '1 adult pool/bar',
        pools: '2 pools',
...
let es = {
    ...
    paragraphMan: 'Princesa de Peñasco ofrece condominios de calidad frente a la playa. Sus instalaciones están equipadas para satisfacer las necesidades de sus clientes durante su estancia.',
    listPrincesa: {
        security: 'Seguridad de 24 hrs',
        parking: 'Estacionamiento',
        restaurant: 'Restaurante bar "Colin\'s"',
        store: 'Tienda de conveniencia',
        gym: 'Gimnasio',
        grill: 'Asadores comunitarios',
        adultPool: '1 alberca/bar para adultos',
        pools: '2 albercas',
