...
const SlideShow = (props: { children: ReactElement[] }) => {
  ...
  return (
    ...
    >
      {props.children.map((element: ReactElement, index: number) => (
        <div
          key={index}
      ...
      >
        ...
        <img
          ...
          id="img01"
          src={props.children[imageID].props.src}
          alt=""
        />
      </div>
    </div>
